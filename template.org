#+TITLE: Performance of Survival Models on Predictive Maintenance of Construction Machines
#+STARTUP: beamer
#+STARTUP: align fold
...
#+NAME: repair
#+CAPTION: Repair overview
[[./Logos/repair_schema.png]]
...
#+NAME: intervention
#+CAPTION: Intervention overview
[[./Logos/intervention_schema.png]]
...
#+NAME: survival
#+CAPTION: Survival function shape
[[./Logos/survival.png]]
...
\\
   ...
   in time often refferred as *cutoff* point. The covariate values in this point
...
#+NAME: survival2
#+CAPTION: Survival function residual
[[./Logos/survival2.png]]
...
#+NAME: final
#+CAPTION: Comparison with the no covariate case
[[./Logos/finalbrier2.png]]
...
*** References :B_block:
  ...
  1. Hisham M. Said and Tony Nicoletti. Telematics data-driven prognostics system for construction heavy equipment health monitoring and assessment. Construction Specialty Conference, 2015.
  2. Hisham M. Said, Tony Nicoletti, and Peter Perez-Hernandez. Utilizing telematics data to support effective equipment fleet-management decisions: Utilization rate and hazard functions. Journal of Computing in Civil Engineering, 2015.
